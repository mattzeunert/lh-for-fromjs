...
class GatherRunner {
  ...
  static async setupDriver(driver, options) {
    ...
    // await driver.evaluateScriptOnNewDocument(
    //   require("fs").readFileSync("/Users/mattzeunert/Documents/GitHub/FromJS/packages/core/helperFunctions_browser.js", "utf-8")
    // )
  ...
  static async populateBaseArtifacts(passContext) {
    ...
    console.log("Inspect base artifacts:" + global["__fromJSGetTrackingIndex"](JSON.stringify(baseArtifacts)))
    console.log("######")
    console.log("######")
    console.log("######")
    console.log("######")
