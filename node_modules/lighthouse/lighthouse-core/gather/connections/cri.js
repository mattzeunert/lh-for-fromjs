...
class CriConnection extends Connection {
  ...
  sendRawMessage(message) {
    console.log("sendRawMessage", (message || "").slice(0, 200))
    require("fs").writeFileSync("./tmp/"+ new Date().valueOf() + "_" + JSON.stringify(message).slice(0, 25).replace(/[^a-zA-Z0-9]/g, "-")+".txt", JSON.stringify(message, null, 2));
    if (!this._ws) {
