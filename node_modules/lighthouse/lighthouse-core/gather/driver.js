...
class Driver {
  ...
  _innerSendCommand(method, ...params) {
    ...
    if (params[0] && method === "Runtime.evaluate") {
      if (params[0].expression.includes(`__nativePromise.resolve()`)) {
        ...
        params[0].expression = require("fs").readFileSync("packages/core/helperFunctions.js", "utf-8") + params.expression
      }
  ...
  async _evaluateInContext(expression, contextId) {
    ...
    expression = `(function wrapInNativePromise() {
      ...
      ${require("fs").readFileSync("packages/core/helperFunctions.js", "utf-8")};
