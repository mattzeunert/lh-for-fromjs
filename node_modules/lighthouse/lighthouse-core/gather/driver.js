...
global["helperFunctions"] ="(function(){})();"
if (require("fs").existsSync("packages/core/helperFunctions.js")) {
  global["helperFunctions"] =require("fs").readFileSync("packages/core/helperFunctions.js", "utf-8").replace(/BACKEND_PORT_PLACEHOLDER/g, "7000")
...
class Driver {
  ...
  _innerSendCommand(method, ...params) {
    ...
    if (params[0] && method === "Runtime.evaluate") {
      ...
      if (params[0].expression.includes(`__nativePromise.resolve()`)) {
